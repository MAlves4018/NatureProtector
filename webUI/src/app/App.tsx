...
import { ChakraProvider, createSystem, defaultConfig, defineConfig, Box } from '@chakra-ui/react';
...
const DashBoards = lazy(() =>
  import('./components/views/dashBoards').then((module) => ({ default: module.DashBoards })),
);
const Pipeline = lazy(() => import('./components/views/Pipeline').then((module) => ({ default: module.Pipeline })));
const DeveloperRuntimeControl = lazy(() =>
  import('./components/views/DeveloperRuntimeControl').then((module) => ({ default: module.DeveloperRuntimeControl })),
);
