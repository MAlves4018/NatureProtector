...
export function UserModal({ isDark, user, isOpen, onClose }: UserModalProps) {
    ...
    return createPortal(
        <div
            ...
            onClick={onClose}
        >
            <div style={modalBackdropStyle(c)} />
            <div
                style={modalContentStyle(c)}
                ...
                {user ?
                    (
                        <>
                            ...
                            <button style={buttonStyle("logout")} onClick={handleLogout}>
                                Logout
                            </button>
                        </>
                    ) : (
...
function modalBackdropStyle(colors: ReturnType<typeof getColors>) {
    return {
