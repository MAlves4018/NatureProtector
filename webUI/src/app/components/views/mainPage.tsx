      ...
      >
        <section style={{ display: 'flex', flexDirection: 'column', gap: '18px' }}>
          ...
          <div style={{ color: c.textPrimary, fontSize: '18px', lineHeight: 1.55, maxWidth: '820px' }}>
            O Nature Protector permite simular cenários ambientais, processar leituras de sensores, calcular risco
            operacional, emitir alertas e analisar evidência runtime de forma rastreável.
          </div>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(190px, 1fr))', gap: '12px' }}>
            <ValueCard
              colors={c}
              icon={<Flame size={18} />}
              title="Simulação controlada"
              text="Cenários com sensores, ciclos, seed e degradação configurável."
            />
            <ValueCard
              colors={c}
              icon={<GitBranch size={18} />}
              title="Pipeline rastreável"
              text="Eventos, inbox, retries, quarantine, risco, projeções e alertas visíveis."
            />
            <ValueCard
              colors={c}
              icon={<ShieldCheck size={18} />}
              title="Evidência runtime"
              text="Auditoria, comparação B/C e dados para relatório e demo."
            />
          </div>
        ...
        >
          ...
          <div style={{ position: 'relative', marginBottom: '20px' }}>
            ...
            >
              <option value="" disabled style={{ color: c.textSecond }}>
                Select an area
              </option>
              {areas.map((area) => (
            ...
            >
              ...
              >
                <title>Open area selector</title>
