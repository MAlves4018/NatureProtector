...
describe('api client', () => {
  ...
  it.each([
    ['getCurrentCapabilities', () => api.getCurrentCapabilities(), '/api/users-roles/me/capabilities', 'GET', undefined],
    ...
    ['listOperationCatalog', () => api.listOperationCatalog('runtime evidence'), '/api/control/operations/catalog?category=runtime%20evidence', 'GET', undefined],
    ['listOperations', () => api.listOperations('cloud ops', 12), '/api/control/operations?take=12&category=cloud+ops', 'GET', undefined],
    ['getOperation', () => api.getOperation('op-1'), '/api/control/operations/op-1', 'GET', undefined],
    [
      'startOperation',
      () => api.startOperation({ operationId: 'quality-smoke', environment: 'ci', ref: 'HEAD', inputs: {}, collectEvidence: true, confirmation: null }),
      '/api/control/operations',
      'POST',
      { operationId: 'quality-smoke', environment: 'ci', ref: 'HEAD', inputs: {}, collectEvidence: true, confirmation: null },
    ],
    ...
    ['compareEvidenceOperations', () => api.compareEvidenceOperations('left-1', 'right-1'), '/api/control/evidence/compare?left=left-1&right=right-1', 'GET', undefined],
    ...
    ['getAreaSensorNodes', () => api.getAreaSensorNodes('area 1'), '/api/control/areas/area 1/sensor-nodes', 'GET', undefined],
    ['listSimulationRuns without filters', () => api.listSimulationRuns(null, null, 25), '/api/control/simulation-runs?take=25', 'GET', undefined],
    ['getRuntimeSummary', () => api.getRuntimeSummary('area 1', 45), '/api/control/runtime/summary?areaCode=area+1&recentMinutes=45', 'GET', undefined],
    ['getRuntimeSummary without area', () => api.getRuntimeSummary(undefined, 15), '/api/control/runtime/summary?recentMinutes=15', 'GET', undefined],
    ['getRuntimeRunAudit', () => api.getRuntimeRunAudit('run-1'), '/api/control/runtime/runs/run-1/audit', 'GET', undefined],
    ['getRuntimeOperationByRun', () => api.getRuntimeOperationByRun('run/1'), '/api/control/runtime/runs/run%2F1/operation', 'GET', undefined],
    ['getRuntimeRunTimings', () => api.getRuntimeRunTimings('run-1'), '/api/control/runtime/runs/run-1/timings', 'GET', undefined],
    ['getRuntimeOperationalHealth', () => api.getRuntimeOperationalHealth(), '/api/control/runtime/observability/health', 'GET', undefined],
    ['getRuntimeRabbitMqMetrics', () => api.getRuntimeRabbitMqMetrics(), '/api/control/runtime/observability/rabbitmq', 'GET', undefined],
    ['listRuntimeEvidence', () => api.listRuntimeEvidence(), '/api/control/runtime/observability/evidence', 'GET', undefined],
    ['getRuntimeDiagnostics', () => api.getRuntimeDiagnostics(), '/api/control/runtime/diagnostics', 'GET', undefined],
    [
      'executeRuntimeDiagnostic',
      () => api.executeRuntimeDiagnostic('diag 1', { runId: 'run-1', options: { limit: '10' } }),
      '/api/control/runtime/diagnostics/diag 1',
      'POST',
      { runId: 'run-1', options: { limit: '10' } },
    ],
    [
      'startRuntimeRun',
      () => api.startRuntimeRun({ scenarioCode: 'scenario_b', areaCode: 'area-1', degradationProfileCodes: ['none'] }),
      '/api/control/runtime/runs',
      'POST',
      { scenarioCode: 'scenario_b', areaCode: 'area-1', degradationProfileCodes: ['none'] },
    ],
    ['getRuntimeOperation', () => api.getRuntimeOperation('op/1'), '/api/control/runtime/operations/op%2F1', 'GET', undefined],
    ['getRuntimeOperationByRequest', () => api.getRuntimeOperationByRequest('request/1'), '/api/control/runtime/operations/by-request/request%2F1', 'GET', undefined],
    [
      'resetRuntimeState',
      () => api.resetRuntimeState({ mode: 'dry-run', confirmation: 'CONFIRM', includeInfrastructure: false }),
      '/api/control/runtime/reset',
      'POST',
      { mode: 'dry-run', confirmation: 'CONFIRM', includeInfrastructure: false },
    ],
    ['getControlledValidationP3Availability', () => api.getControlledValidationP3Availability(), '/api/dev/controlled-validation/p3', 'GET', undefined],
    [
      'startControlledValidationP3',
      () => api.startControlledValidationP3({ runLabel: 'p3-smoke', scenarioCode: 'scenario_b', areaCode: 'area-1' }),
      '/api/dev/controlled-validation/p3/run',
      'POST',
      { runLabel: 'p3-smoke', scenarioCode: 'scenario_b', areaCode: 'area-1' },
    ],
