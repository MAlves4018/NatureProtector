...
export const HELP_TOPICS: readonly HelpTopic[] = [
  topic(
    ...
    'Visao geral',
    'Overview',
    'Mostra o estado do prototipo e os proximos passos seguros.',
    'Shows prototype status and safe next steps.',
    'A pagina nao substitui a beta nem declara operacao real.',
  ...
  topic(
    ...
    'Risco',
    'Risk',
    'Resultado calculado pelo prototipo quando existem dados elegiveis.',
    'Prototype-calculated output when eligible data exists.',
    'Nao e alerta oficial nem calibracao cientifica final.',
  ...
  topic(
    ...
    'Origem dos dados',
    'Data origin',
    'Identifica se o valor vem do catalogo, runtime ou projecao persistida.',
    'Identifies whether a value comes from catalog, runtime or persisted projection.',
    'Origem nao implica validacao externa.',
  ...
  topic(
    ...
    'Cobertura',
    'Coverage',
    'Resume cobertura de sensores, celulas ou leituras quando disponivel.',
    'Summarizes sensor, cell or reading coverage when available.',
    'Cobertura baixa nao deve ser escondida.',
  ...
  topic(
    ...
    'Nao transforma parametros candidatos em validacao cientifica.',
  ...
  topic(
    ...
    'Requested/resolved',
    'Requested/resolved',
    'Compara o pedido submetido com a configuracao resolvida pelo backend.',
  ...
  topic(
    'degradationProfile',
    'Perfil de degradacao',
    'Degradation profile',
    'Perfil controlado usado para simular degradacao de observacoes.',
    'Controlled profile used to simulate observation degradation.',
    'Nao representa falha operacional real.',
  ...
  topic(
    ...
    'Estado da run',
    'Run state',
    'Mostra o estado persistido da run selecionada.',
  ...
  topic(
    ...
    'Pipeline',
    'Pipeline',
    'Resume ingestao, tentativas, rejeicoes e quarentena quando expostos.',
    'Summarizes ingestion, attempts, rejections and quarantine when exposed.',
    'Nao cria metricas novas.',
  ...
  topic(
    ...
    'Qualidade',
    'Quality',
    'Distingue testes, execucao e evidencia de qualidade.',
    'Distinguishes tests, execution and quality evidence.',
    'Resultados historicos podem estar desatualizados.',
  ...
  topic(
    ...
    'Paths internos ficam em detalhes tecnicos.',
  ...
  topic(
    ...
    'Nao integrado em scoring, alertas, schema ou runtime.',
