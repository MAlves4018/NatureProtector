...
2. PostgreSQL local e Cloud SQL usam a mesma implementação Npgsql e o mesmo contrato `POSTGRES_*`; cloud exige configuração explícita, TLS e CA montado em `POSTGRES_ROOT_CERTIFICATE`.
