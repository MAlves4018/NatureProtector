...
\clearpage
% Removed forced blank page after cover.
% \thispagestyle{empty}
% \cleardoublepage
...
% Removed because the acronym list was almost empty and consumed pages.
% Lista manual compacta de acrónimos e símbolos


%\typeout{Lista de Acrónimos e Símbolos}
...
\tableofcontents 
% Removed because the list of figures was almost empty and consumed pages.
% \listoffigures 
%\listoftables   
...
% Appendices removed because they were empty/desalinhados and generated blank pages.
...
%% APA style
% Bibliography temporarily removed because the current References section was empty.
% Re-enable these two lines when References/References.bib has real entries and citations use valid keys.
\clearpage
