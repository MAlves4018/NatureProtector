...
semantic_checks = {
    ...
    "autopilot-bootstrap-uses-low-operator-cpu-requests": (ROOT / "scripts/cloud/install-g81-cluster-dependencies-autopilot.sh", '"cpu":"100m"'),
    "autopilot-bootstrap-keeps-low-explicit-operator-memory-requests": (ROOT / "scripts/cloud/install-g81-cluster-dependencies-autopilot.sh", '"memory":"128Mi"'),
