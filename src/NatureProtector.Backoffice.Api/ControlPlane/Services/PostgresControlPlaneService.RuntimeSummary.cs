...
public sealed partial class PostgresControlPlaneService : IControlPlaneService
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return new RuntimeAreaOperationalSummaryResponse(
                ...
                projectedState.AssessmentCount > 0 ? projectedState.AggregateRiskScore : null,
                projectedState.AssessmentCount > 0 ? projectedState.AggregateRiskLevel : "Unknown",
                projectedState.AssessmentCount > 0 ? projectedState.Severity : "Info",
